...
--Aim
local mode = "arg_weapon_m4a1(aim)"
...
--Aim
local mode = "weapon_m4a1(aim-hands)"
BSF_RAGDOLLCONTROL_ANIMATION.AnimationSets["default"][mode] = function(rag)
...
BSF_RAGDOLLCONTROL_ANIMATION.AnimationSets["default"][mode] = function(rag)
	...
	elseif(time<1.7)then
		...
		curangs[2] = curangs[2]
		curangs[3] = curangs[3]
		curangs:RotateAroundAxis(curangs:Up(),104-40)
		curangs:RotateAroundAxis(curangs:Right(),-26)
		curangs:RotateAroundAxis(curangs:Forward(),70)
		curangs = LerpAngle(BSF_RAGDOLLCONTROL_ANIMATION:Anim_GetTimeLerp(time,passedtime,waittime,false),b_upperarml:GetAngles(),curangs)
		BSF_RAGDOLLCONTROL:ControllPhysBone(b_upperarml,nil,curangs)
	...
	elseif(time<2.0)then
		...
		curangs[3] = curangs[3]
		curangs:RotateAroundAxis(curangs:Up(),104-40)
		curangs:RotateAroundAxis(curangs:Right(),-36)
		curangs:RotateAroundAxis(curangs:Forward(),140)
		curangs = LerpAngle(BSF_RAGDOLLCONTROL_ANIMATION:Anim_GetTimeLerp(time,passedtime,waittime,false),b_upperarml:GetAngles(),curangs)
		BSF_RAGDOLLCONTROL:ControllPhysBone(b_upperarml,nil,curangs)
